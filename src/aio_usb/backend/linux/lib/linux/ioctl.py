...
def _IOR(type: int, nr: int, size: type) -> int:
    return _IOC(_IOC_READ, type, nr, _IOC_TYPECHECK(size))


def _IOW(type: int, nr: int, size: type) -> int:
    return _IOC(_IOC_WRITE, type, nr, _IOC_TYPECHECK(size))


def _IOWR(type: int, nr: int, size: type) -> int:
    return _IOC(_IOC_READ | _IOC_WRITE, type, nr, _IOC_TYPECHECK(size))


def _IOR_BAD(type: int, nr: int, size: type) -> int:
    return _IOC(_IOC_READ, type, nr, ctypes.sizeof(size))


def _IOW_BAD(type: int, nr: int, size: type) -> int:
    return _IOC(_IOC_WRITE, type, nr, ctypes.sizeof(size))


def _IOWR_BAD(type: int, nr: int, size: type) -> int:
...
def _IOC_DIR(nr: int) -> int:
    return (nr >> _IOC_DIRSHIFT) & _IOC_DIRMASK


def _IOC_TYPE(nr: int) -> int:
    return (nr >> _IOC_TYPESHIFT) & _IOC_TYPEMASK


def _IOC_NR(nr: int) -> int:
    return (nr >> _IOC_NRSHIFT) & _IOC_NRMASK


def _IOC_SIZE(nr: int) -> int:
