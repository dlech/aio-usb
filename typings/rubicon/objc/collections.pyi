...
class ObjCStrInstance(ObjCInstance):
    ...
    def __rmul__(
        ...
        ...
    def find(self, sub: object, start: int = ..., end: int = ...) -> int | Any: ...
    def index(self, sub: object, start: int = ..., end: int = ...) -> int | Any: ...
    def rfind(self, sub: object, start: int = ..., end: int = ...) -> int | Any: ...
    def rindex(self, sub: object, start: int = ..., end: int = ...) -> int | Any: ...
